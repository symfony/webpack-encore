...
import cssExtractLoaderUtil from './loaders/css-extract.ts';
// loaders utils
import cssLoaderUtil from './loaders/css.ts';
import handlebarsLoaderUtil from './loaders/handlebars.ts';
import lessLoaderUtil from './loaders/less.ts';
import sassLoaderUtil from './loaders/sass.ts';
...
import jsMinimizerPluginUtil from './plugins/js-minimizer.ts';
