...
const features = {
    ...
    'minify-js-esbuild': {
        ...
        packages: [{ name: 'esbuild', enforce_version: true }],
        description: 'minify JS with esbuild',
    },
    'minify-js-swc': {
        method: 'configureJsMinimizerPlugin()',
        packages: [{ name: '@swc/core', enforce_version: true }],
        description: 'minify JS with SWC',
    },
    'minify-js-uglify': {
        method: 'configureJsMinimizerPlugin()',
        packages: [{ name: 'uglify-js', enforce_version: true }],
        description: 'minify JS with UglifyJS',
    },
    'minify-css-lightningcss': {
        method: 'configureCssMinimizerPlugin()',
        packages: [{ name: 'lightningcss', enforce_version: true }],
        description: 'minify CSS with Lightning CSS',
    },
    'minify-css-cssnano': {
        method: 'configureCssMinimizerPlugin()',
        packages: [
            { name: 'cssnano', enforce_version: true },
            { name: 'postcss', enforce_version: true },
        ],
        description: 'minify CSS with cssnano',
    },
    'minify-css-csso': {
        method: 'configureCssMinimizerPlugin()',
        packages: [{ name: 'csso', enforce_version: true }],
        description: 'minify CSS with CSSO',
    },
    'minify-css-clean-css': {
        method: 'configureCssMinimizerPlugin()',
        packages: [{ name: 'clean-css', enforce_version: true }],
    ...
    'minify-css-swc': {
        method: 'configureCssMinimizerPlugin()',
        packages: [{ name: '@swc/css', enforce_version: true }],
