...
class WebpackConfig {
    constructor(runtimeConfig, enablePackageJsonCheck = false) {
        ...
        this.shouldInjectEnvironmentVariables = false;
        this.environmentVariablesPath = null; // will
    ...
    injectEnvironmentVariables(path = './.env') {
        this.shouldInjectEnvironmentVariables = true;
        this.environmentVariablesPath = path;
    }
