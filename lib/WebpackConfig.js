...
class WebpackConfig {
    constructor(runtimeConfig, enablePackageJsonCheck = false) {
        ...
        this.useImageWebpackLoader = false;
        ...
        this.imageWebpackLoaderCallback = () => {};
    ...
    enableImageWebpackLoader(imageWebpackLoaderOptionsOrCallback = () => {}) {
        this.useImageWebpackLoader = true;

        if (typeof imageWebpackLoaderOptionsOrCallback === 'function') {
            this.imageWebpackLoaderCallback = imageWebpackLoaderOptionsOrCallback;
            return;
        }

        if (typeof imageWebpackLoaderOptionsOrCallback === 'object') {
            this.imageWebpackLoaderCallback = (options) => {
                Object.assign(options, imageWebpackLoaderOptionsOrCallback);
            };
            return;
        }

        throw new Error('Argument 1 to enableImageWebpackLoader() must be either a object or callback function.');
    }
