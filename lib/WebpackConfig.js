...
// used only to check plugins integrations, loaders features
// are checked in its own module
const features = require('./loader-features');
...
class WebpackConfig {
    constructor(runtimeConfig) {
        ...
        this.forkedTypeScriptTypesCheckOptions = {};
    }
    ...
    enableForkedTypeScriptTypesChecking(forkedTypeScriptTypesCheckOptions = {}) {
        ...
        // check earlier for missing plugin modules to avoid node error:
        // Cannot find module 'module-name'
        features.ensureLoaderPackagesExist('forkedtypecheck');

        this.useForkedTypeScriptTypeChecking = true;
        this.forkedTypeScriptTypesCheckOptions = forkedTypeScriptTypesCheckOptions;
    }
