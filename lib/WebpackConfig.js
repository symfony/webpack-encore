    ...
    setPublicPath(publicPath) {
        ...
        if (publicPath.includes('://')) {
            if (this.webpackDevServerUrl) {
                throw new Error('You cannot pass an absolute URL to setPublicPath() and useWebpackDevServer() at the same time. Try using Remix.isProduction() to only configure each setting when needed.');
            }
        } else {
