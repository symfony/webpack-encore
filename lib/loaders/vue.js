...
module.exports = {
    getLoaders(webpackConfig) {
        ...
        const loaders = {
             ...
             *
             * We're overriding those defaults so that we can use mini-css-extract-plugin,
        ...
        if (webpackConfig.useSassLoader) {
            loaders.scss = cssExtract.prependLoaders(
                webpackConfig,
             ...
             * sass-loader.
             */
            loaders.sass = cssExtract.prependLoaders(
                webpackConfig,
        ...
        if (webpackConfig.useLessLoader) {
            loaders.less = cssExtract.prependLoaders(
                webpackConfig,
