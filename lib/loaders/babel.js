    ...
    async getLoaders(webpackConfig) {
        ...
        if (!await webpackConfig.doesBabelRcFileExist()) {
            ...
            Object.assign(babelConfig, {
                presets: [
                    [import.meta.resolve('@babel/preset-env'), presetEnvOptions]
                ],
                plugins: []
            });
            ...
            if (webpackConfig.useBabelTypeScriptPreset) {
                ...
                babelConfig.presets.push([import.meta.resolve('@babel/preset-typescript'), webpackConfig.babelTypeScriptPresetOptions]);
            }
            ...
            if (webpackConfig.usePreact) {
                ...
                if (webpackConfig.preactOptions.preactCompat) {
                    ...
                    babelConfig.plugins.push([import.meta.resolve('@babel/plugin-transform-react-jsx')]);
                } else {
            ...
            if (webpackConfig.useVueLoader && webpackConfig.vueOptions.useJsx) {
                ...
                babelConfig.plugins.push(import.meta.resolve('@vue/babel-plugin-jsx'));
            }
