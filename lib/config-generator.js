...
const environmentPluginUtil = require('./plugins/environment');
...
class ConfigGenerator {
    ...
    buildPluginsConfig() {
        ...
        if (this.webpackConfig.shouldInjectEnvironmentVariables) {
            environmentPluginUtil(plugins, this.webpackConfig);
        }
