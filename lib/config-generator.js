    ...
    buildPluginsConfig() {
        let plugins = [
            ...
            new ManifestPlugin({
                ...
                // prefixes all keys with (e.g.) /builds/, which allows us to refer to
                // the paths as /builds/main.css on the server, instead of just main.css
                basePath: this.webpackConfig.publicPath
            }),
