...
const imageWebpackLoaderUtil = require('./loaders/image-webpack');
// plugins utils
...
class ConfigGenerator {
    ...
    buildRulesConfig() {
        ...
        if (this.webpackConfig.useImageWebpackLoader) {
            rules.push(applyRuleConfigurationCallback('image-webpack', {
                test: /\.(gif|png|jpe?g|svg)$/i,
                loader: 'image-webpack-loader',
                options: imageWebpackLoaderUtil.getOptions(this.webpackConfig)
            }));
        }
