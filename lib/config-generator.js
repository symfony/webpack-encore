...
class ConfigGenerator {
    ...
    buildRulesConfig() {
        ...
        if (this.webpackConfig.useImagesLoader) {
            ...
            let filename = this.webpackConfig.useVersioning ? 'images/[name].[hash:8].[ext]' : 'images/[name].[ext]';
        ...
        if (this.webpackConfig.useFontsLoader) {
            ...
            let filename = this.webpackConfig.useVersioning ? 'fonts/[name].[hash:8].[ext]' : 'fonts/[name].[ext]';
