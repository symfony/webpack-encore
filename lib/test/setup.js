 ...
 * @param {Array} linkHrefs   Used to create <link href=""> tags.
 * @param {Function} callback Called after the page was requested.
 */
function requestTestPage(webRootDir, scriptSrcs, linkHrefs, callback) {
    var scripts = '';
    ...
    for (let linkHref of linkHrefs) {
        links += `<link rel="stylesheet" href="${linkHref}" />`;
    }
